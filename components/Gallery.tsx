...
const Gallery = () => {
  return (
    <section className="flex flex-col w-full items-start justify-start my-4">
      <h3 className="text-6xl font-bold w-full my-4 px-4">GALLERY</h3>
      <div className="px-6 flex justify-center w-full gap-5 items-center flex-wrap">
